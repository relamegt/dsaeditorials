...
public class Main {
    ...
    // 3. Different number and types
    static double calculate(int a, double b, int c) {
        return a + b + c;
    }

    public static void main(String[] args) {
        System.out.println("int + int       : " + calculate(10, 20));
        System.out.println("int + int + int : " + calculate(10, 20, 30));
        System.out.println("double + double : " + calculate(3.5, 6.5));
        System.out.println("int+double+int  : " + calculate(5, 2.5, 3));
    }
}
```
```C
...
// C does not support function overloading natively.
// Each variant requires a distinct name.
int calculate_ii(int a, int b)           { return a + b; }
int calculate_iii(int a, int b, int c)   { return a + b + c; }
double calculate_dd(double a, double b)  { return a + b; }
double calculate_idd(int a, double b, int c) { return a + b + c; }

int main() {
    printf("int + int       : %d\n",   calculate_ii(10, 20));
    printf("int + int + int : %d\n",   calculate_iii(10, 20, 30));
    printf("double + double : %.1f\n", calculate_dd(3.5, 6.5));
    printf("int+double+int  : %.1f\n", calculate_idd(5, 2.5, 3));
    return 0;
}
```
```Python
# Python does not natively support overloading.
# Default arguments and *args achieve equivalent behavior.
...
if __name__ == "__main__":
    print("int + int       :", calculate(10, 20))
    print("int + int + int :", calculate(10, 20, 30))
    print("double + double :", calculate(3.5, 6.5))
    print("int+double+int  :", calculate(5, 2.5, 3))
```
```JavaScript
// JavaScript does not support overloading natively.
// Argument count and type checks simulate the behavior.
...
console.log("int + int       :", calculate(10, 20));
console.log("int + int + int :", calculate(10, 20, 30));
console.log("double + double :", calculate(3.5, 6.5));
console.log("int+double+int  :", calculate(5, 2.5, 3));
```
